...
public class CreateUser_Command implements Command{
	...
	public void execute() throws SQLException {
		...
		if (rowsInserted > 0) {
			JOptionPane.showMessageDialog(null, "회원 가입 완료", "Signup success"
					, JOptionPane.INFORMATION_MESSAGE);
			System.out.println("A new user was inserted successfully!");
		}else {
			JOptionPane.showMessageDialog(null, "이미 있는 id 입니다. 다른 id를 입력해 주세요."
					, "Signup Fail!", JOptionPane.ERROR_MESSAGE);
